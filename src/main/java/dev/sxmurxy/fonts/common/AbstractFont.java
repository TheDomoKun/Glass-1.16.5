package dev.sxmurxy.fonts.common;
...
import dev.sxmurxy.fonts.TextureHelper;
...
public abstract class AbstractFont implements Wrapper {
	...
	public static final Font getFont(String fileName, int style, int size) {
		String path = Glass.FONT_DIR.concat(fileName);
		Font font = null;
		
		try {
			font = Font.createFont(Font.TRUETYPE_FONT, Glass.class.getResourceAsStream(path))
