package dev.sxmurxy.fonts.styled;
...
import dev.sxmurxy.fonts.Wrapper;
		...
		for(int i = 0; i < text.length(); i++) {
			...
			if (c0 == 167 && i + 1 < text.length() &&
				...
				if(strikethrough) {
					...
					BUILDER.pos(matrix, posX, posY + h + 3, 0).color(red, green, blue, alpha).endVertex();
					BUILDER.pos(matrix, posX + f, posY + h + 3, 0).color(red, green, blue, alpha).endVertex();
					BUILDER.pos(matrix, posX + f, posY + h, 0).color(red, green, blue, alpha).endVertex();
					BUILDER.pos(matrix, posX, posY + h, 0).color(red, green, blue, alpha).endVertex();
					TESSELLATOR.draw();
				...
				if(underline) {
					...
					BUILDER.begin(7, DefaultVertexFormats.POSITION_COLOR);
					BUILDER.pos(matrix, posX, y1 + 4, 0).color(red, green, blue, alpha).endVertex();
					BUILDER.pos(matrix, posX + f, y1 + 4, 0).color(red, green, blue, alpha).endVertex();
					BUILDER.pos(matrix, posX + f, y1 + 2, 0).color(red, green, blue, alpha).endVertex();
					BUILDER.pos(matrix, posX, y1 + 2, 0).color(red, green, blue, alpha).endVertex();
					TESSELLATOR.draw();
