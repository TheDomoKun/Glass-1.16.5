...
import x.glass.client.module.utils.HoverUtil;
...
public class Button {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        // SimplifiedFontRenderer.drawShadowedCenteredXYString(matrixStack, Glass.font, module.name, x + width / 2, y + height / 2, module.included ? Color.RED : Color.WHITE);
    }
