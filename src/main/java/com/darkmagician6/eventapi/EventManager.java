...
public final class EventManager {
	 ...
	 */
	private static final Map<Class<? extends com.darkmagician6.eventapi.events.Event>, List<MethodData>> REGISTRY_MAP = new HashMap<Class<? extends com.darkmagician6.eventapi.events.Event>, List<MethodData>>();
     ...
     */
    public static void register(Object object, Class<? extends com.darkmagician6.eventapi.events.Event> eventClass) {
        for (final Method method : object.getClass().getDeclaredMethods()) {
     ...
     */
    public static void unregister(Object object, Class<? extends com.darkmagician6.eventapi.events.Event> eventClass) {
    ...
    private static void register(Method method, Object object) {
    	Class<? extends com.darkmagician6.eventapi.events.Event> indexClass = (Class<? extends com.darkmagician6.eventapi.events.Event>) method.getParameterTypes()[0];
    	//New MethodData from the Method we are registering.
    	final MethodData data = new MethodData(object, method, method.getAnnotation(Event.class).value());
     ...
     */
    public static void removeEntry(Class<? extends com.darkmagician6.eventapi.events.Event> indexClass) {
        Iterator<Map.Entry<Class<? extends com.darkmagician6.eventapi.events.Event>, List<MethodData>>> mapIterator = REGISTRY_MAP.entrySet().iterator();
     ...
     */
    private static void sortListValue(Class<? extends com.darkmagician6.eventapi.events.Event> indexClass) {
     ...
     * @see Event
     */
    private static boolean isMethodBad(Method method, Class<? extends com.darkmagician6.eventapi.events.Event> eventClass) {
     ...
     */
    public static final com.darkmagician6.eventapi.events.Event call(final com.darkmagician6.eventapi.events.Event event) {
     ...
     * TODO: Error messages.
     */
    private static void invoke(MethodData data, com.darkmagician6.eventapi.events.Event argument) {
        try {
